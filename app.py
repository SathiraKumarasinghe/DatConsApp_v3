...
try:
    ...
    # Main panel setup
    display_app_header(main_txt='DataCon',
                       sub_txt='Clean and restruct text data')
    
    st.markdown("""---""")
    
    st.write('Welcome to the DatCon! An app for automated preprocessing of data.')
